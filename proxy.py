...
def server_loop(local_host, local_port, remote_host, remote_port, receive_first):
	...
	try: 
		...
		print "[!] Check for other listening sockets on the same port or correct permissions."
		sys.exit(0)
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
	...
	# receive data from the remote end of necessary
	if receive_first:
	...
	# now lets loop and read from local, send to remote, send to local, rinse wash and repeat
	while True:
